...
dx,dy,dz = 0.57, 0.57, 0.6 # dimensions
nx,ny,nz = 15, 15, 15 # number of elements per dimension
...
############################################################
# engngModel
problem = liboofem.engngModel("nldeidynamic",1,nSteps=5,dumpCoef=.1,deltaT=10000,outFile="/tmp/surf7_oofem.out")
...
mat = liboofem.isoLE(1, domain, d=2000, E=2e6, n=0.2, tAlpha=0)
