...
fem = [os.path.join(directory,f) for f in os.listdir(directory) if f.startswith("surf7_oofem.out.m1.") and f.endswith(".vtu")]
...
# DEM
dem = [os.path.join(directory,f) for f in os.listdir(directory) if f.startswith("surf7_yade-polyhedra-") and f.endswith(".vtk")]
